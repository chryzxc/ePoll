                ...
                public void onClick(View view) {
                    if (UserProfile.userType.equals("Faculty") || UserProfile.userType.equals("Administrator")) {
                        ...
                        if (holder.pollCounts.getCardBackgroundColor().getDefaultColor() == ContextCompat.getColor(ct,
                            ...
                            //      DocumentReference up = mStore.collection("Poll").document(myList.getDocu1());
                      ...
                      //      Map<String, Object> logs = new HashMap<>();
                         ...
                         //   logs.put(new Date().toString(), "Removed choice '" + myList.getName() + "' in poll question '" + myList.getDocu2() + "'.");
                        ...
                        //    documentReference.update(logs);
                            ...
                            if (counts < myList.getLimit()) {
                              ...
                              //  Map<String, Object> logs = new HashMap<>();
                                // long dateNow = new Date().getTime();
                            //    logs.put(new Date().toString(), "You chose '" + myList.getName() + "' in poll question '" + myList.getDocu2() + "'.");
                             //   DocumentReference documentReference = mStore.collection("Users").document(mAuth.getCurrentUser().getUid()).collection("others").document("logs");
                             //   documentReference.update(logs);
