...
public class AdminVerification extends AppCompatActivity {
    static List<AdminVerificationList> myLists;
    static RecyclerView rv;
    static AdminVerificationAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // myLayout = inflater.inflate(R.layout.verification_user_box, null);
...
//
                                              ...
                                              //  cStore.collection("Verification").document(cloudID).delete();
                                              //  Map <String,Object> logs = new HashMap<>();
                                              //  logs.put(new Date().toString(),"Account verified.");
                                             //   DocumentReference documentReference = cStore.collection("Users").document(cloudID).collection("others").document("logs");
                                             ...
                                             //   Snackbar.make(parentLayout, "User account approved", Snackbar.LENGTH_LONG)
                                             //           .show();
                        ...
                        if (task.isSuccessful()) {
                            String studentID = task.getResult().getString("id");
                                ...
                                if(task.getResult().exists()){
                                 ...
                                 //   verificationClose.setPaintFlags(verificationClose.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
                                            ...
                                            cStore.collection("Verification").document(id).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()){
                                                        ...
                                                        //  Snackbar.make(parentLayout, "User successfully rejected", Snackbar.LENGTH_LONG)
                                                        //        .show();
