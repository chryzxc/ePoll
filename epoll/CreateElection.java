...
public class CreateElection extends AppCompatActivity {
    ...
    static List<CreateElectionList> myLists;
    static RecyclerView rv;
    static CreateElectionAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  candidateID.setFilters(new InputFilter[] { filter });
       ...
       // partyList.add("Independent");
        ...
        fabElectionDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //data.putExtra("partylist",  partyList);
