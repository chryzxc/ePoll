...
public class UserProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // idnumberEdit.setInputType(InputType.TYPE_NUMBER_FLAG_DECIMAL);
       // idnumberEdit.setKeyListener(DigitsKeyListener.getInstance("0123456789-"));
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            }else if (userType.matches("Administrator"))
                            {
                              ...
                              /*  imageViewemail.setVisibility(View.VISIBLE);
                                fullnameText.setText("Administrator");
                                emailText.setText("Email: " + document.get("email"));
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
           ...
           //     per.update("total_votes", FieldValue.increment(1));
              ...
              //  upd.put(new Date().toString(),emailEdit.getText().toString());
                ...
                documentReference.update(upd).addOnSuccessListener(new OnSuccessListener<Void>() {
                   ...
                   //     long dateNow = new Date().getTime();
                     //   logs.put(String.valueOf(dateNow),"Profile updated.");
                     //   DocumentReference documentReference = mStore.collection("Users").document(userId).collection("others").document("logs");
                        ...
                        if (document.exists()) {
                            mStore.collection("Election").document(document.getId()).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    ...
                                    // Toast.makeText(UserProfile.this, entry.getKey().toString(), Toast.LENGTH_SHORT).show();



                                    if (new Date().after(date_start)){
                                        start = true;
                                        //Toast.makeText(UserProfile.this, "start true" + name, Toast.LENGTH_SHORT).show();
                                    }
                                    ...
                                    if (new Date().before(date_end)){
                                        ...
                                        //  Toast.makeText(UserProfile.this, "end true" + name, Toast.LENGTH_SHORT).show();

                                    }


                                    if (start == true && end == true ){
                                       // Toast.makeText(UserProfile.this, "Live : " + name.toString(), Toast.LENGTH_SHORT).show();
                                        liveList.add(name);
    ...
    private void getdataStudent() {
      ...
      //  myLists.add(new UserList(R.drawable.faq,"FAQ"));
