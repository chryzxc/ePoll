...
public class CreatePoll extends AppCompatActivity {
    ...
    static List<CreatePollList> myLists;
    static RecyclerView rv;
    static CreatePollAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //limitNum = findViewById(R.id.limitNum);
...
/*
                ...
                for(int x = 0;x < myLists.size() -1;x++){
                    ...
                    insert.put(myLists.get(x).getChoice(),0);


                }

                Toast.makeText(context, insert.toString(), Toast.LENGTH_SHORT).show();

                int listSize = AdminPoll.myLists.size() -1 ;

                AdminPoll.myLists.remove(listSize);
                Toast.makeText(context, String.valueOf(myLists.size()), Toast.LENGTH_SHORT).show();
              //  AdminPoll.rv.setAdapter(AdminPoll.adapter);

               // AdminPoll.myLists.add(new AdminPollList("qwe",insert,null,null,null));

           //     AdminPoll.myLists.add(new AdminPollList(null,null,null,null,null));
           //     AdminPoll.adapter = new AdminPollAdapter(AdminPoll.myLists, context);
            //    AdminPoll.rv.setAdapter(AdminPoll.adapter);
             //   finish();
