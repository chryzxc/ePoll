...
public class AdminPoll extends AppCompatActivity {
    static List<AdminPollList> myLists;
    static RecyclerView rv;
    static AdminPollAdapter adapter;
...
//here
                ...
                documentReference.set(poll).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    //    logs.put(new Date().toString(),"You created a poll " + title +".");
...
//here
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_EXAMPLE) {
           ...
           //
                //
                //    Toast.makeText(this, limitFinal.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void getdata() {
        //myLists.add(new AdminPollList("MISS uni", "1-10s"));
      //  myLists.add(new AdminPollList("FOR RPES", "1-23"));
