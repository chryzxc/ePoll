    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              // Toast.makeText(ct, "docu1 "+myList.getDocu1() + " docu 2 " + myList.getDocu2(), Toast.LENGTH_SHORT).show();
        ...
        holder.selectView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Toast.makeText(ct,"counts: "+counts.toString()+"limit : "+  myList.getLimit().toString(), Toast.LENGTH_SHORT).show();
                ...
                //    Map<String,Object> logs = new HashMap<>();
                 ...
                 //   logs.put(String.valueOf(dateNow),"You withdrew your vote '" + myList.getName() + "' for '" +myList.getDocu2()+"'.");
                 ...
                 //   documentReference.update(logs);
                  ...
                  //      Map<String,Object> logs = new HashMap<>();
                    //    long dateNow = new Date().getTime();
                    //    logs.put(String.valueOf(dateNow),"You voted '" + myList.getName() + "' for '" +myList.getDocu2()+"'.");
                    //    DocumentReference documentReference = mStore.collection("Users").document(mAuth.getCurrentUser().getUid()).collection("others").document("logs");
                    //    documentReference.update(logs);
